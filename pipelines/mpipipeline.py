...
if __name__=="__main__":
    ...
    print("Calculate each part itself on each node with batch dedisperse_n_fft")
    ...
    try:
        ...
        for line in ddplan:
            ...
            pool.map_async(func=func_wrap, iterable=zip(subDM_list, prepsubband_sub_cmd, prepsubband_nsub_cmd, realfft_cmd, accelsearch_cmd))
            pool.close()
            pool.join()
